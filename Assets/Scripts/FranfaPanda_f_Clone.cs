...
public class FrankaPanda_f_Clone : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Base = GameObject.Find("Panda_Base_Clone");
        J1 = GameObject.Find("Panda_J1_Clone");
        J2 = GameObject.Find("Panda_J2_Clone");
        J3 = GameObject.Find("Panda_J3_Clone");
        J4 = GameObject.Find("Panda_J4_Clone");
        J5 = GameObject.Find("Panda_J5_Clone");
        J6 = GameObject.Find("Panda_J6_Clone");
        J7 = GameObject.Find("Panda_J7_Clone");
        TCP = GameObject.Find("TCP_fingers_Clone");
    ...
    void Update()
    {
        ...
        q = new float[] { (qq[0] * Mathf.Rad2Deg), (qq[1] * Mathf.Rad2Deg), (qq[2] * Mathf.Rad2Deg), (qq[3] * Mathf.Rad2Deg), (qq[4] * Mathf.Rad2Deg), (qq[5] * Mathf.Rad2Deg), (qq[6] * Mathf.Rad2Deg) };
    ...
    void OnGUI()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            GUI.Label(new Rect(10, i * 30, 0, 0), "q" + (i + 1) + "= " + System.Math.Round(q[i], 2) + "¡Æ", style);
        }
    }
}
